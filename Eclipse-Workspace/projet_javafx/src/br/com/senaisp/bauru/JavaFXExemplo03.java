...
public class JavaFXExemplo03 extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		...
		LinearGradient lg= new LinearGradient(
				//StarX, StarY,EndX, EndY, Proporcional,
				//Forma Ciclos gradiente, Stops
				0, 1, 1, 0, true, CycleMethod.NO_CYCLE,
				new Stop[] {
						new Stop(0,Color.BLACK),new Stop(0.5,Color.YELLOW),new Stop(1,Color.BLUE)
				});
		RadialGradient rg = new RadialGradient(//Angulo Foco,Dist foco,CentroX, CentroY, Raio,Proporcional
				//Formas Ciclos gradiente, Stops

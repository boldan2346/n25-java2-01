...
public class JavaFXExercicio01 extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		...
		//Criando o componentes da tela
		criarComponentes(noRoot);
		//Criando a cena
		Scene cena  = new Scene(noRoot,800,600,Color.PINK);
	...
	private void criarComponentes(Group noRoot) {
		//Componentedo nó root
		HBox cmp01 = new HBox();
		Rectangle cmp02 = new Rectangle(100,100,Color.GREENYELLOW);
		...
		cmp03.setStrokeLineJoin(StrokeLineJoin.ROUND);// Junção arredondados
		//Criando efeitos de sombra 
